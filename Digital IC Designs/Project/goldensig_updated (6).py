# Python script for golden signature calculation
# -*- coding: utf-8 -*-
"""
...
for step in range(nsteps):
    ...
    # Correct mapping: A0-A7 (LSB to MSB) from PRSG bits 0-7 (prsg[8:16]), B0-B7 (LSB to MSB) from PRSG bits 8-15 (prsg[0:8])
    ...
    if sisrstyle == 0:
        ...
        # Galois SISR: new bit at D0, shift right, feedback at taps
        feedback = sisr[0]  # D15
